...
train1 = np.genfromtxt('./1.Bivariate/overlapping_data/group7/class1_train.txt', delimiter=' ')
train2 = np.genfromtxt('./1.Bivariate/overlapping_data/group7/class2_train.txt', delimiter=' ')
train3 = np.genfromtxt('./1.Bivariate/overlapping_data/group7/class3_train.txt', delimiter=' ')
...
test1 = np.genfromtxt('./1.Bivariate/overlapping_data/group7/class1_test.txt', delimiter=' ')
test2 = np.genfromtxt('./1.Bivariate/overlapping_data/group7/class2_test.txt', delimiter=' ')
test3 = np.genfromtxt('./1.Bivariate/overlapping_data/group7/class3_test.txt', delimiter=' ')
...
val1 = np.genfromtxt('./1.Bivariate/overlapping_data/group7/class1_val.txt', delimiter=' ')
val2 = np.genfromtxt('./1.Bivariate/overlapping_data/group7/class2_val.txt', delimiter=' ')
val3 = np.genfromtxt('./1.Bivariate/overlapping_data/group7/class3_val.txt', delimiter=' ')
...
z = np.loadtxt("initial"+".txt", delimiter=' ',dtype=np.float64)
...
for iter in xrange(100):
	...
	if(iter == 0 or iter == 2 or iter == 5):
		...
		Z = np.loadtxt("softkmeanskernel1(c)"+str(iter)+".txt", delimiter=',',dtype = np.int)
		xr = xx.ravel()
		yr = yy.ravel()
		...
		plt.scatter(train2[:,0],train2[:,1],c = 'm',label = 'train class 2');
		plt.scatter(train3[:,0],train3[:,1],c = 'y',label = 'train class 3');

		plt.xlabel('Feature 1')
		plt.ylabel('Feature 2')
		plt.title('Dataset3, kernel k means soft clustering,iteration:'+str(iter)+'number of clusters:'+str(M))
		...
		plt.xticks(())
		plt.yticks(())
		plt.savefig("softkmeanskernel1(c)"+str(iter)+".png", bbox_inches='tight')
		plt.close(fig)
